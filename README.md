...
Only `OPENAI_API_KEY` is required; `SERPER_API_KEY` and `GITHUB_TOKEN` improve patent and code
search. `PATENTLOOP_MODEL` overrides the model (default `gpt-4o-mini`).
